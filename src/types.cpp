...
cancel_option_order_info_t cancel_option_order_info_t::construct(const flatjson::fjson &json)
{
    assert(json.is_valid());
    cancel_option_order_info_t res{};
...
std::ostream &operator<<(std::ostream &os, const cancel_option_order_info_t &o)
{
    os
    << "{"
    << "\"orderId\":\"" << o.orderId << "\","
...
cancel_linear_future_order_info_t cancel_linear_future_order_info_t::construct(const flatjson::fjson &json)
{
    assert(json.is_valid());
    cancel_linear_future_order_info_t res{};
...
std::ostream &operator<<(std::ostream &os, const cancel_linear_future_order_info_t &o)
{
    os
    << "{"
    << "\"clientOrderId\":\"" << o.clientOrderId << "\","
...
cancel_inverse_future_order_info_t cancel_inverse_future_order_info_t::construct(const flatjson::fjson &json)
{
    assert(json.is_valid());
    cancel_inverse_future_order_info_t res{};
...
std::ostream &operator<<(std::ostream &os, const cancel_inverse_future_order_info_t &o)
{
    os
    << "{"
    << "\"avgPrice\":\"" << o.avgPrice << "\","
